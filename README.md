...
### 1. Why LangGraph?
**Decision:** Use LangGraph StateGraph instead of simple function calls

**Rationale:**
- Provides true state management between agents
- Makes workflow explicit and debuggable
- Enables easy addition of conditional branching
- Industry-standard for multi-agent systems
- Better error handling and recovery

**Trade-offs:**
- Slight learning curve vs simple functions
- More boilerplate code
- Worth it for scalability and maintainability

### 2. Why SQLite?
**Decision:** SQLite for database instead of in-memory structures
...
**Trade-offs:**
- File I/O overhead vs in-memory
- Single-writer limitation
- Easily upgradeable to PostgreSQL/MySQL for production

### 3. Why Gemini API?
**Decision:** Google Gemini over other LLM providers

**Rationale:**
- Free tier sufficient for assignment
- Fast response times (<2s)
- Good instruction following for structured prompts
- Easy API setup
...
- Could use Ollama for local deployment

### 4. Why Weighted Scoring?
**Decision:** 100-point transparent scoring vs black-box ML model

**Rationale:**
- Explainable to healthcare stakeholders
- Adjustable weights based on business needs
...
- Perfect for this use case (transparency > complexity)

### 5. Why Transaction Management?
**Decision:** Explicit BEGIN/COMMIT/ROLLBACK transactions

**Rationale:**
- Atomic updates prevent partial assignments
